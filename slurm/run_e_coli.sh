...
SNK_DIR="/hpcfs/users/a1667917/s_aureus/Mass_Motif_Finder"
...
conda activate snakemake_clean_env
 ...
 snakemake -c 1 -s runner.smk --use-conda --profile $PROF_DIR/bact_assembly  --config Fastas='/hpcfs/users/a1667917/s_aureus/e_coli_fasta' \
